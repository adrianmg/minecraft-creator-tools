    ...
    if (this.rootElt !== null && this.rootElt.current !== null) {
      ...
      TuiGrid.applyTheme("default", {
        ...
        selection: {
          ...
          border: colors.background2,
        },
        scrollbar: {
          background: colors.background1,
          thumb: colors.background3,
          emptySpace: colors.background2,
          border: colors.background3,
          active: colors.background4,
        },
        row: {
          even: {
            background: colors.background1,
        ...
        cell: {
          normal: {
            background: colors.background2,
            border: colors.background4,
            showVerticalBorder: true,
            text: colors.foreground2,
          },
          header: {
            background: colors.background4,
            border: colors.background3,
            showVerticalBorder: true,
            text: colors.foreground4,
          },
          rowHeader: {
            border: colors.background3,
            showVerticalBorder: true,
