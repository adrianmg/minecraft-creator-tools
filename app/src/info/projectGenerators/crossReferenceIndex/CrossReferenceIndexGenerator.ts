...
export default class CrossReferenceIndexGenerator implements IProjectInfoGenerator, IValidationRuleProvider {
  ...
  private async indexGeometry(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
  ...
  private async indexAnimationResource(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexAnimationBehavior(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexAnimationControllerResource(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexAnimationControllerBehavior(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexRenderController(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexParticle(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexFog(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexSoundDefinitions(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private indexLootTable(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
  ...
  private async indexRecipe(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexBiome(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private async indexSpawnRule(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
    if (!projectItem.isContentLoaded) {
      await projectItem.loadContent();
    }
  ...
  private indexDialogue(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
  ...
  private indexFunction(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
  ...
  private indexStructure(projectItem: ProjectItem, contentIndex: ContentIndex, path: string) {
